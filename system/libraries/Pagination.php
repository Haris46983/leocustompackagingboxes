...
class CI_Pagination {
	...
	var $first_link			= '<span class="btn btn-sm btn-primary">First</span>';
	var $next_link			= '<span class="page-link page-link-btn"><i class="fa fa-angle-right"></i></span>';
	var $prev_link			= '<span class="page-link page-link-btn"><i class="fa fa-angle-left"></i></span>';
	// var $last_link			= 'Last &rsaquo;';
	// var $last_link			= 'Last &raquo;';
	var $last_link			= '<span class="btn btn-sm btn-primary">Last</span>';
	var $uri_segment		= 3;
	...
	var $cur_tag_open		= '<li class="page-item active"><a href="javascript:;"><strong>';
