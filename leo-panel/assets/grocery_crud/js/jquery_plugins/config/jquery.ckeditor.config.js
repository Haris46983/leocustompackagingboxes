...
$(function() {
		...
		['Maximize', 'ShowBlocks','-','About','CreatePlaceholder']
				...
				filebrowserBrowseUrl: '/a_printing_circle/admin/assets/grocery_crud/texteditor/kcfinder/browse.php?opener=ckeditor&type=files',
                filebrowserImageBrowseUrl: '/a_printing_circle/admin/assets/grocery_crud/texteditor/kcfinder/browse.php?opener=ckeditor&type=images',
                filebrowserFlashBrowseUrl: '/a_printing_circle/admin/assets/grocery_crud/texteditor/kcfinder/browse.php?opener=ckeditor&type=flash',
                filebrowserUploadUrl: '/a_printing_circle/admin/assets/grocery_crud/texteditor/kcfinder/upload.php?opener=ckeditor&type=files',
                filebrowserImageUploadUrl: '/a_printing_circle/admin/assets/grocery_crud/texteditor/kcfinder/upload.php?opener=ckeditor&type=images',
                filebrowserFlashUploadUrl: '/a_printing_circle/admin/assets/grocery_crud/texteditor/kcfinder/upload.php?opener=ckeditor&type=flash'
